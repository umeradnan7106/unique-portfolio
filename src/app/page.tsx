...
import myImage from "../../public/image/WhatsApp Image 2024-11-07 at 2.55.05 AM.jpeg";
import skill1 from "../../public/image/icons8-html-250.png";
import skill2 from "../../public/image/icons8-css-250.png";
import skill3 from "../../public/image/icons8-javascript-250.png";
import skill4 from "../../public/image/icons8-tailwind-css-240.png";
import skill5 from "../../public/image/icons8-react-js-250.png";
import skill6 from "../../public/image/icons8-typescript-250.png";
import skill7 from "../../public/image/icons8-node-js-256.png";
import shakehand from "../../public/image/icon_handshake-1.webp";
import email from "../../public/image/icons8-mail-250.png";
import UX from "../../public/image/UX_icon-25-1024.webp";
import monitor from "../../public/image/depositphotos_115258084-stock-illustration-computer-monitor-mouse-and-keyboard-removebg-preview.png";
import development from "../../public/image/backend-development-icon-style-vector-removebg-preview.png";
import creative from "../../public/image/icons8-creative-300.png";

export default function Home() {
  const textToCopy = "umeradnan7106@gmail.com";
      ...
      <div className="max-w-[1550px] justify-self-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex text#000000D6] m-5">
              <div className="text-xs sm:text-base">
                <a href="https://www.linkedin.com/in/umer-adnan-a1b881291/">
                  LinkedIn/
                </a>
              </div>
              <div className="text-xs sm:text-base">
                <a href="https://www.facebook.com/umer.adnan.790">Facebook/</a>
              </div>
              <div className="text-xs sm:text-base">
                {" "}
          ...
          <div className="lg:flex lg:justify-center">
            <div className="justify-items-center sm:flex sm:space-x-14 justify-center my-16">
              <div className="my-4 w-52">
                ...
                <div className="text-[#848484] w-52">
                  Desining interfaces that are intuitive, efficient, and
                  enjoyable to use.
                </div>
              </div>
            ...
            <div className="justify-items-center sm:flex sm:space-x-14 justify-center my-16">
              ...
              <div className=" my-4 w-52">
                ...
                <div className="text-[#848484] w-52">
                  Bringing your vision to life wit the latest technology and
                  design trends.
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-t-[65px] pt-16 ">
          ...
          <div className="flex justify-between m-4">
            <div className="text-[#242424] text-xs sm:text-base">
              © unique resume.
            </div>
